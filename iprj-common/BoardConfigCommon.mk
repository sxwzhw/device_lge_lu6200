...
BOARD_CUSTOM_GRAPHICS := ../../../device/lge/lu6200/iprj-common/recovery-gfx.c
TARGET_USERIMAGES_USE_EXT4 := true

COMMON_GLOBAL_CFLAGS += -DQCOM_HARDWARE

TARGET_SPECIFIC_HEADER_PATH := device/lge/lu6200/iprj-common/include
...
BOARD_EGL_CFG := device/lge/lu6200/iprj-common/egl.cfg
...
BOARD_BLUEDROID_VENDOR_CONF := device/lge/lu6200/iprj-common/vnd_bt.txt
TARGET_DISPLAY_INSECURE_MM_HEAP := true
TARGET_DISPLAY_USE_RETIRE_FENCE := true

BOARD_SEPOLICY_DIRS += \
        device/lge/lu6200/iprj-common/sepolicy
...
BOARD_HARDWARE_CLASS := device/lge/lu6200/iprj-common/cmhw/
